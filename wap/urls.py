...
urlpatterns = [
    ...
    path('movie/<int:location_id>/<int:cinema_id>/<int:film_id>', views.get_film_detail_by_cinema, name='get_film_detail_by_cinema'),
    path('movie/<int:film_id>', views.get_film_detail, name='get_film_detail'),

    path('ticket_type/<int:location_id>/<int:cinema_id>/<int:film_id>/<int:session_id>', views.ticket_type, name='get_ticket_type_by_cinema'),
    path('ticket_type/<int:film_id>/<int:session_id>', views.ticket_type, name='get_ticket_type'),

    path('choose_seats/<int:location_id>/<int:cinema_id>/<int:film_id>/<int:session_id>/<int:book_service_id>', views.get_seats, name='get_seats_by_cinema'),
